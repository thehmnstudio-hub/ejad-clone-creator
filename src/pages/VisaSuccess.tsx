  ...
  useEffect(() => {
    if (window.fbq) {
      window.fbq('track', 'Lead', {
        content_name: 'Visa Desk Lead',
        content_category: 'Visa Desk',
              ...
              <Card className="border-2">
                <CardContent className="pt-12 pb-12 text-center">
                  ...
                  <p className="text-lg text-muted-foreground mb-8">
                    Your visa desk application has been received successfully.
                  </p>
                  ...
                  <div className="space-y-6">
                    <div className="bg-muted/30 rounded-lg p-4 text-left">
                      ...
                      <ul className="space-y-1.5 text-sm text-muted-foreground">
                        ...
                        <li>✍️ Based on the interview, your visa application will be approved or declined</li>
                        <li>🚀 Approved applicants will receive next steps via email</li>
                      </ul>
                    </div>
