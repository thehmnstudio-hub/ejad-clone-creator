  ...
  useEffect(() => {
    if (window.fbq) {
      window.fbq('track', 'Lead', {
        content_name: 'Ejad Plus Qualified Lead',
        content_category: 'Company Formation',
              ...
              <Card className="border-2">
                <CardContent className="pt-12 pb-12 text-center">
                  ...
                  <p className="text-lg text-muted-foreground mb-8">
                    Your USA company formation application has been received successfully.
                  </p>
